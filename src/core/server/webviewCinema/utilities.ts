...
// import { CinemaWebViewEventNames } from '../../shared/enums/webViewEvents.js';
...
//     player.emit(CinemaWebViewEventNames.ON_SERVER, eventName, ...args);
// }
...
//     player.emit(CinemaWebViewEventNames.CLOSE_PAGES, pages);
// }
