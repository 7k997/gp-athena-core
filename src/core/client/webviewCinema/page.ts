...
//             AthenaClient.webviewCinema.disableEscapeKeyForPage(this.info.name);
//         }

//         AthenaClient.webviewCinema.ready(page.name, page.callbacks.onReady);
//     }
...
//             if (AthenaClient.webviewCinema.isPageOpen(this.info.name)) {
//                 this.close(true);
//                 return false;
//             }
//         }

//         if (AthenaClient.webviewCinema.isAnyMenuOpen() && !this.info.options.onOpen.forceOpen) {
//             return false;
//         }
...
//         await AthenaClient.webviewCinema.openPages([this.info.name], hideOverlays, this.close.bind(this));
//         return true;
//     }
...
//             AthenaClient.webviewCinema.closePages([this.info.name], showOverlays);
//         }

//         if (!isManuallyTriggered && showOverlays) {
//             AthenaClient.webviewCinema.setOverlaysVisible(true, false);
//         }

//         if (this.info.options.onClose.hideCursor) {
//             AthenaClient.webviewCinema.showCursor(false);
//         }

//         if (this.info.options.onClose.unfocus) {
//             AthenaClient.webviewCinema.unfocus();
//         }
