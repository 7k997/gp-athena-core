...
// import { CinemaWebViewEventNames } from '@AthenaShared/enums/webViewEvents.js';
...
//         AthenaClient.webviewCinema.registerPersistentPage(PAGE_NAME);
//         AthenaClient.webviewCinema.on(CinemaWebViewEventNames.PLAY_SOUND, CinemaAudioView.play3DAudio);
//         AthenaClient.webviewCinema.on(CinemaWebViewEventNames.PLAY_SOUND_FRONTEND, AthenaClient.systems.sound.frontend);
//     }
...
//         const view = await AthenaClient.webviewCinema.get();
