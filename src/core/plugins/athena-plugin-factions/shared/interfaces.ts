...
export interface IAutomat {
    /**
     * The name of this automat facility.
     *
     * @type {string}
     * @memberof IAutomat
     */
    ...
    /**
     * Position of the automat facility
     *
     * @type {Vector3}
     * @memberof IAutomat
     */
    ...
    /**
     * Allow what ranks to use this automat facility?
     *
     * @type {Array<string>}
     * @memberof IAutomat
     */
...
export interface Faction extends FactionCore {
    ...
    /**
     * Automates that belong to this faction.
     *
     * @type {Array<FactionStorage>}
     * @memberof Faction
     */
    automates?: Array<IAutomat>;
}
