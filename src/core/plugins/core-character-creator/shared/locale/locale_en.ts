export const CHARACTER_CREATOR_LOCALE_EN = {
    ...
    LABEL_CHAR_AGE: 'Age',
    LABEL_CHAR_GENDER: 'Gender',
    LABEL_CHAR_LANG: 'Language',
    ...
    characterLanguage: 'What language does your character speak?',
    BUTTON_VERIFY_NAME: 'Verify Name',
    BUTTON_FINISH: 'Finish',
    MESSAGE_LANGUAGE: 'language must 2 characters (en, de, es, fr, etc.)',
    MESSAGE_NO_SPECIAL: 'No special characters allowed',
    MESSAGE_GENDER: 'Gender must be at least 3 characters',
    MESSAGE_MINIMUM_YEAR: 'Minimum Year:',
    MESSAGE_MAXIMUM_YEAR: 'Maximum Year:',
    MESSAGE_DAY: 'Day is 1 to 31',
    MESSAGE_MONTH: 'Month is 1 to 12',
    MESSAGE_NAME_SPECIAL: 'Cannot contain special characters',
    MESSAGE_NAME_TAKEN: 'Name is already taken',
    MESSAGE_NAME_LENGTH: 'Must between 3 and 24 characters',
    appearanceComponent: {
