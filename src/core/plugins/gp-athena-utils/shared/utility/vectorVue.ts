import { Vector2, Vector3 } from '../interfaces/vector.js';

export function distance(vector1: Vector3, vector2: Vector3) {
    return distanceWithRef('ref not specified', vector1, vector2);
}

export function distanceWithRef(referenceName: string, vector1: Vector3, vector2: Vector3) {
...
export function distance2dWithRef(referenceName: string, vector1: Vector2, vector2: Vector2) {
    if (vector1 === undefined || vector2 === undefined) {
