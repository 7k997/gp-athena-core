...
export async function createDefaultInteriors() {
    ...
    //     outside: new alt.Vector3({ x: 935.1909790039062, y: 46.17036819458008, z: 80.09584045410156 }),
    //     inside: new alt.Vector3({ x: 1089.8856201171875, y: 206.2451629638672, z: -49.5 }),
    //     objects: [],
    ...
    //     uid: 'some-cool-house',
    //     outside: new alt.Vector3({ x: -841.6432495117188, y: -24.96125030517578, z: 39.39847183227539 }),
    //     inside: new alt.Vector3({ x: -786.8663, y: 315.7642, z: 216.6385 }),
    //     system:
